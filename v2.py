...
thread = int(input("•Amount of threads")
URL = 'https://i.instagram.com/api/v2/accounts/login/'
...
nameurl = 'https://i.instagram.com/api/v2/accounts/set_username/'
namedata = {
